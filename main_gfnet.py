...
def main(args):
    ...
    if args.eval:
        ...
        if args.export_eval_features:
            data_loader_val = [ds.set_with_domain_label(True) for ds in dataset for dataset in data_loader_val]
            data_loader_test = [ds.set_with_domain_label(True) for ds in dataset for dataset in data_loader_test]
